...
/*
  ...
  Modified for Wishlist v3 Phoenix
...
// EOF WISHLIST
        ...
        break;
      default:
        $customers_query = tep_db_query("select c.*, a.* from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . (int)$_GET['cID'] . "'");
